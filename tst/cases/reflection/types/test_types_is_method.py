...
class TestTypesIsMethod:
    ...
    def test_string_method_returns_true(self) -> None:
        """Test that string method returns True."""
        assert types_is_method("hello".upper)
        assert types_is_method("hello".lower)
        assert types_is_method("hello".split)

    def test_list_method_returns_true(self) -> None:
        """Test that list method returns True."""
        assert types_is_method([].append)
        assert types_is_method([].extend)
        assert types_is_method([].pop)

    def test_dict_method_returns_true(self) -> None:
        """Test that dict method returns True."""
        assert types_is_method({}.get)
        assert types_is_method({}.keys)
        assert types_is_method({}.values)
